...
import {
  ...
  ShieldAlert, Users, FileText, Sparkles, Settings, Menu, X
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-2.5 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-[57px] z-30">
        ...
        <button
          ...
          className="p-1.5 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 bg-slate-50 dark:bg-slate-800 font-bold text-xs flex items-center gap-1.5"
        >
      ...
      <aside className={`
        ...
        ${mobileOpen 
          ? 'fixed top-[95px] bottom-0 left-0 w-72 z-50 bg-white dark:bg-slate-900 shadow-2xl border-r border-slate-200 dark:border-slate-800' 
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 flex items-center justify-around py-2 px-1 mobile-nav-shadow mobile-safe-bottom">
        {[
          { id: 'dashboard' as AppScreen, icon: <LayoutDashboard className="w-5 h-5" />, label: 'Home' },
          { id: 'smarthome' as AppScreen, icon: <Home className="w-5 h-5" />, label: 'Smart Home' },
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 px-2.5 py-1 rounded-xl text-[10px] font-bold transition-all active:scale-95 ${
